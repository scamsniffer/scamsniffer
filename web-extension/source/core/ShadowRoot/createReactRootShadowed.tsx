 ...
 */
export function createReactRootShadowedPartial(
  hostConfig: CreateRenderInShadowRootHostConfig
) {
  return function createReactRootShadowed(
    ...
    function tryRender(): void {
      ...
      if (shadowRoot.host?.parentNode === null)
        return void setTimeout(tryRender, 20);

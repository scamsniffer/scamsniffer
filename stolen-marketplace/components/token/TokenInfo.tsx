      ...
      <div className="mb-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <a
            ...
            href={`https://looksrare.org/collections/${token?.asset_contract?.address}/${token?.token_id}`}
          >
            <img
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            href={`https://opensea.io/assets/${token?.asset_contract?.address}/${token?.token_id}`}
          >
            <img
        ...
        <div className="mb-4 flex items-center justify-between">
          ...
          <div>
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              href={`https://etherscan.io/address/${token?.asset_contract?.address}`}
            >
              {truncateAddress(token?.asset_contract?.address)}
